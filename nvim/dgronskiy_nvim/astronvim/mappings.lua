...
function M.astronvim_mappings_callback(_)
  ...
  merged = vim.tbl_deep_extend("force", astronvim_defaults, {
    n = {
      ["<leader>f<CR>"] = {
...
function M.saner_astronvim_defaults()
  ...
  if is_available "Comment.nvim" then
    maps.n["<leader>c"] = { function() require("Comment.api").toggle.linewise.current() end, desc = "Comment line" }
    maps.v["<leader>c"] = {
  ...
  if is_available "neo-tree.nvim" then
    maps.n["<leader>e"] = { "<cmd>Neotree toggle reveal position=current<cr>", desc = "Toggle Explorer" }
